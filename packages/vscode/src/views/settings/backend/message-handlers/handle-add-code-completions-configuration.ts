...
export const handle_add_code_completions_configuration = async (
  ...
  const config_to_add: ToolConfig = {
    ...
    temperature: DEFAULT_TEMPERATURE['code-completions']
  }
    ...
    switch (selected_option) {
      ...
      case 'Model': {
        ...
        try {
          ...
          Logger.error({
            function_name: 'add_code_completions_configuration case Model',
            message: 'Failed to fetch models',
            data: error
          })
        }
