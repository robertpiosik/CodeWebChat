...
import { DeletePruneContextConfigurationMessage } from '@/views/settings/types/messages'
import { dictionary } from '@shared/constants/dictionary'

export const handle_delete_prune_context_configuration = async (
  provider: SettingsProvider,
  message: DeletePruneContextConfigurationMessage
): Promise<void> => {
  ...
  await providers_manager.save_prune_context_tool_configs(updated_configs)
}
