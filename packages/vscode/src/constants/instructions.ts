...
export const code_completion_instructions_for_panel = (
  ...
  `Find correct replacement text for the <missing_text> symbol. Your response must begin with a Markdown Code Block containing the replacement text, followed by an explanation. The first line of the Markdown Code Block must be: "// ${file_path} ${
    row + 1
  }:${
    column + 1
