...
export const EDIT_FORMAT_INSTRUCTIONS_DIFF =
  'Whenever showing a new, updated, renamed or deleted file, provide brief explanation, then print path in a markdown heading (e.g. ### New file: `src/counter.py`, ### Updated file: `src/counter.py`), followed by a unified diff within a markdown code block. Example:\nThe count variable has been incremented.\n### Updated file: `src/counter.py`\n```diff\n--- a/src/counter.py\n+++ b/src/counter.py\n@@ -2,1 +2,1 @@\n-count = 10\n+count = 20\n```'
