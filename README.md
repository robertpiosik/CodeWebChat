...
> [!TIP]
> Start using smart workspaces called [projects](https://help.openai.com/en/articles/10169521-projects-in-chatgpt), [gems](https://gemini.google/pl/overview/gems), or [spaces](https://docs.github.com/en/copilot/concepts/context/spaces).
...
> [!TIP]
> Do you want to make edits directly from the editor? Use a built-in API tool _Edit Context_.

## Enabling autofill

Got tired with copy and paste? Enable prompt autofill with a browser extension.
