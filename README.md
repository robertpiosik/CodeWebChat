...
Get started with generous free tier from Google via [AI Studio / API Keys](https://aistudio.google.com/api-keys) or any other OpenAI-API compatible model provider.
