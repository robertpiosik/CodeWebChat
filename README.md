...
Here, context is managed by you, directly from the native file explorer so the model has everything it needs without a single tool call. This approach enables a seamless AI coding with chatbots but making direct API calls is also supported.
