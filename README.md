...
A 100% free and open-source VS Code extension for AI-assisted pair programming. Makes fast and accurate changes across multiple files from a single AI response coming from any chatbot or API.
