...
Code Web Chat is a free and open-source (FOSS) AI coding toolkit independently built for speed and privacy. You can use CWC in **VS Code** family of editors (Cursor, Antigravity, VSCodium etc.).
