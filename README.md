...
Although taking care about what the model sees sounds like a chore, the benefits are big. Simple instructions just work and the model is easy to steer with examples.
