...
Although caring about what the model sees sounds like a chore, the benefits are beneficial. Instructions are simple and the model is easy to steer with examples.
