...
With its static context approach, **[prompt caching](https://developers.openai.com/api/docs/guides/prompt-caching) is utilized across tasks** via context files ordering based on update and selection recency.
