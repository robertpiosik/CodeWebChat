...
Although caring about what the model sees sounds like a chore, the reality is that it makes it steerable with examples and more focused on the primary task.
