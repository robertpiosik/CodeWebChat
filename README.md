...
**A 100% free and open-source VS Code extension for AI pair programming.** With its simple, non-agentic design, it provides unmatched accuracy, speed and cost efficiency.
