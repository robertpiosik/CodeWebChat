...
Code Web Chat is an open-source and privacy-first **AI coding toolkit for VS Code**. It helps construct zero-overhead prompts for fast and accurate edits in chatbots. **It's free!**
