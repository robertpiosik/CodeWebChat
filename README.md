...
Since context files are part of your instructions, they are intelligently ordered enabling [prompt caching](https://developers.openai.com/api/docs/guides/prompt-caching/) across tasks. Make your chatbot quotas last longer or reduce input token costs by up to 90%.
