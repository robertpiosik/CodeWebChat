...
Code Web Chat is an open-source and privacy-first **AI coding toolkit for VS Code**. It helps construct zero-overhead prompts **for fast and accurate multi-file edits in chatbots and APIs**. It's 100% free!
...
> [!TIP]
> Use [a built-in API tool](#built-in-api-tools) _Edit Context_ to make multi-file edits directly from the editor.
