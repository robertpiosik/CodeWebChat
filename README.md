...
Code Web Chat (CWC) is a free and open-source, privacy-first **AI coding toolkit for VS Code**. It helps construct zero-overhead XML-formatted prompts with for:

- chatbots—ChatGPT, Claude, Gemini, etc.
- APIs—remote and local model providers

Ask, edit, get code at cursor, and more, without a single tool call!
