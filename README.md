...
Code Web Chat (CWC) is a free and open-source, privacy-first **AI coding toolkit for VS Code**. It helps construct zero-overhead prompts with XML-formatted files and instructions for multi-file edits using:
