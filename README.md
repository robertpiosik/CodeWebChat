...
Code Web Chat (CWC) is a free and open-source AI coding toolkit for VS Code. It helps construct file-dense prompts for chatbots (ChatGPT, Claude, Gemini, etc.) and APIs (remote and local model providers).
