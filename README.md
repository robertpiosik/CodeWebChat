...
A 100% free and open-source VS Code extension for AI-assisted pair programming. Makes coordinated changes across multiple files from a single web chat message or API call.
