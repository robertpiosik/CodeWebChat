...
**A 100% free and open-source tool for AI pair programming.** By its non-agentic, context-first design, it favors concise instructions over mundane specifications. Makes AI predictable, fast and cost efficient.
