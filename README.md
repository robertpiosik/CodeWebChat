...
Code Web Chat is a free and open-source, privacy-first **AI coding toolkit for VS Code**. It helps construct zero-overhead prompts for _fast_ and accurate multi-file edits in your codebase using:
...
> [!NOTE]
> Thanks to smart context files ordering, CWC heavily utilizes [prompt caching](https://developers.openai.com/api/docs/guides/prompt-caching/).
