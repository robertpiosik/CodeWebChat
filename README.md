...
> [!TIP]
> With the browser extension you can include markdown-parsed websites in context! Just click the extension's icon in the toolbar and click _Enable for context_. The website will appear in the context tree immediately.
