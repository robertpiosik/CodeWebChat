...
Code Web Chat is a token-efficient AI coding toolkit for VS Code.
...
> [!TIP]
> Not sure about which files to select? Use a dedicated _Find relevant files_ prompt type.
