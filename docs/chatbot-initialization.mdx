...
Generated prompt depends on prompt type:
...
- **truncated:** Uses Patch Repair API tool placing the original file before changes which serve as instructions for a full file rewrite.
