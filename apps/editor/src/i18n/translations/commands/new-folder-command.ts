export const translations = {
  'command.new-folder-command.title': {
    en: 'New Folder',
    pl: 'Nowy folder',
    'zh-cn': '新建文件夹',
    ja: '新規フォルダ',
  ...
  'command.new-folder-command.prompt': {
    ...
    tr: 'Klasör adını girin',
    cs: 'Zadejte název složky',
    hu: 'Adja meg a mappa nevét',
    bg: 'Въведете име на папката'
  }
} as const
