export const translations = {
  'command.copy-merge-commit-details-command.no-branches': {
  ...
  'command.copy-merge-commit-details-command.title': {
    en: 'Branches',
    pl: 'Gałęzie',
    'zh-cn': '分支',
    ja: 'ブランチ',
  ...
  'command.copy-merge-commit-details-command.no-other-branches': {
  ...
  'command.copy-merge-commit-details-command.no-commits': {
  ...
  'command.copy-merge-commit-details-command.copied': {
