export const translations = {
  ...
  'command.save-file-selection-command.recent-entries': {
    en: 'recent entries',
    pl: 'ostatnie wpisy',
    'zh-cn': '最近的条目',
    ja: '最近のエントリ',
  ...
  'command.save-file-selection-command.entries-az': {
    en: 'entries (A-Z)',
    pl: 'wpisy (A-Z)',
    'zh-cn': '条目 (A-Z)',
    ja: 'エントリ (A-Z)',
  ...
  'command.save-file-selection-command.action.rename': {
    en: 'Rename',
    pl: 'Zmień nazwę',
    'zh-cn': '重命名',
    ja: '名前の変更',
  ...
  'command.save-file-selection-command.action.delete': {
    en: 'Delete',
    pl: 'Usuń',
    'zh-cn': '删除',
    ja: '削除',
  ...
  'command.save-file-selection-command.rename.title': {
    en: 'Rename Context',
  ...
  'command.save-file-selection-command.delete.prompt': {
  ...
  'command.save-file-selection-command.delete.action': {
    en: 'Delete',
    pl: 'Usuń',
    'zh-cn': '删除',
    ja: '削除',
