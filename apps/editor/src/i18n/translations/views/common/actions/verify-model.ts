export const translations = {
  'views.common.actions.verify-model.progress.audio': {
  ...
  'views.common.actions.verify-model.progress.test': {
  ...
  'views.common.actions.verify-model.prompt.test': {
    en: 'Test',
    pl: 'Test',
    'zh-cn': '测试',
    ja: 'テスト',
  ...
  'views.common.actions.verify-model.warning.audio.title': {
  ...
  'views.common.actions.verify-model.warning.test.title': {
  ...
  'views.common.actions.verify-model.status.server-error': {
    en: 'Server Error',
    pl: 'Błąd serwera',
    'zh-cn': '服务器错误',
    ja: 'サーバーエラー',
  ...
  'views.common.actions.verify-model.status.bad-request': {
    en: 'Bad Request',
  ...
  'views.common.actions.verify-model.status.authentication': {
  ...
  'views.common.actions.verify-model.status.forbidden': {
    en: 'Access Forbidden',
    pl: 'Odmowa dostępu',
    'zh-cn': '禁止访问',
    ja: 'アクセスが拒否されました',
  ...
  'views.common.actions.verify-model.status.not-found': {
    en: 'Model not found',
  ...
  'views.common.actions.verify-model.status.rate-limit': {
  ...
  'views.common.actions.verify-model.status.internal': {
  ...
  'views.common.actions.verify-model.status.bad-gateway': {
    en: 'Bad Gateway',
    pl: 'Zła brama',
    'zh-cn': '错误网关',
    ja: 'バッドゲートウェイ',
