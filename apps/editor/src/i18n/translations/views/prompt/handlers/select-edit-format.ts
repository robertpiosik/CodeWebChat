export const translations = {
  ...
  'views.prompt.handlers.select-edit-format.items.whole.hint': {
    en: 'use for difficult refactors',
    pl: 'używaj do trudnych refaktoryzacji',
    'zh-cn': '用于困难的重构',
    ja: '難しいリファクタリングに使用',
    'zh-tw': '用於困難的重構',
    de: 'für schwierige Refactorings verwenden',
    es: 'usar para refactorizaciones difíciles',
    fr: 'à utiliser pour les refactorisations difficiles',
    'pt-br': 'usar para refatorações difíceis',
    ru: 'использовать для сложного рефакторинга',
    ko: '어려운 리팩토링에 사용',
    it: 'usa per refactoring difficili',
    tr: 'zorlu yeniden yapılandırmalar için kullanın',
    cs: 'použít pro složité refaktorování',
    hu: 'nehéz refaktoráláshoz ajánlott',
    bg: 'използвайте за трудни рефакторинги'
  },
