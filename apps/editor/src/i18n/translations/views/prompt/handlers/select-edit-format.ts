export const translations = {
  ...
  'views.prompt.handlers.select-edit-format.items.whole.hint': {
    en: 'easiest, perfect for complex edits',
    pl: 'najprostszy, idealny do złożonych edycji',
    'zh-cn': '最简单，非常适合复杂的编辑',
    ja: '最も簡単、複雑な編集に最適',
    'zh-tw': '最簡單，非常適合複雜的編輯',
    de: 'am einfachsten, perfekt für komplexe Bearbeitungen',
    es: 'el más fácil, perfecto para ediciones complejas',
    fr: 'le plus simple, parfait pour les éditions complexes',
    'pt-br': 'mais fácil, perfeito para edições complexas',
    ru: 'самый простой, идеально подходит для сложных правок',
    ko: '가장 쉽고 복잡한 편집에 완벽함',
    it: 'il più semplice, perfetto per modifiche complesse',
    tr: 'en kolayı, karmaşık düzenlemeler için mükemmel',
    cs: 'nejjednodušší, ideální pro složité úpravy',
    hu: 'legkönnyebb, tökéletes összetett szerkesztésekhez',
    bg: 'най-лесният, идеален за сложни редакции'
  },
