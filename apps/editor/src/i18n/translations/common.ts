export const common = {
  ...
  'common.progress.sent': {
    en: 'sent {tokens} tokens...',
    pl: 'wysłano {tokens} tokenów...',
    'zh-cn': '已发送 {tokens} 个 token...',
    ja: '{tokens} トークンを送信しました...',
    'zh-tw': '已發送 {tokens} 個 token...',
    de: '{tokens} Token gesendet...',
    es: 'enviados {tokens} tokens...',
    fr: '{tokens} jetons envoyés...',
    'pt-br': 'enviou {tokens} tokens...',
