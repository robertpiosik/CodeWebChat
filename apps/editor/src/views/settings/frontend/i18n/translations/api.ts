export const translations = {
  ...
  'api.system-instructions.edit-files.title': {
    en: 'Editing files',
    pl: 'Edytowanie plików',
    'zh-cn': '编辑文件',
    ja: 'ファイルの編集',
    'zh-tw': '編輯檔案',
    de: 'Dateien bearbeiten',
    es: 'Edición de archivos',
    fr: 'Modification de fichiers',
    'pt-br': 'Edição de arquivos',
    ru: 'Редактирование файлов',
    ko: '파일 편집',
    it: 'Modifica file',
    tr: 'Dosyaları düzenleme',
    cs: 'Úprava souborů',
  ...
  'api.system-instructions.edit-files.description': {
    ...
    ru: 'Инструкции по тону и стилю для модели.',
    ko: '모델의 어조 및 스타일 지침.',
    it: 'Istruzioni di tono e stile per il modello.',
    tr: 'Model için ton ve stil talimatları.',
    cs: 'Pokyny pro tón a styl modelu.',
    hu: 'Hangnem és stílus utasítások a modellhez.',
    bg: 'Инструкции за тон и стил за модела.'
  }
} as const