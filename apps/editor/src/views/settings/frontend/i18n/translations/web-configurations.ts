export const web_configurations = {
  ...
  'web-configurations.notice': {
    ...
    tr: 'Web yapılandırmaları, tarayıcıdan çeşitli sohbet robotlarını kullanmanızı sağlar.',
    cs: 'Webové konfigurace umožňují používat různé chatboty z prohlížeče.',
    hu: 'A webes konfigurációk lehetővé teszik a különböző chatbotok böngészőből történő használatát.',
    bg: 'Уеб конфигурациите ви позволяват да използвате различни чатботове от браузъра.'
  },
