export const configurations = {
  'configurations.subtitle': {
    en: 'Manage your API configurations.',
    pl: 'Zarządzaj swoimi konfiguracjami API.',
    'zh-cn': '管理您的 API 配置。',
    ja: 'API 設定を管理します。',
    'zh-tw': '管理您的 API 設定。',
    de: 'Ihre API-Konfigurationen verwalten.',
    es: 'Gestionar sus configuraciones de API.',
    fr: 'Gérer vos configurations API.',
    'pt-br': 'Gerenciar suas configurações de API.',
    ru: 'Управление вашими конфигурациями API.',
    ko: 'API 구성을 관리합니다.',
    it: 'Gestisci le tue configurazioni API.',
    tr: 'API yapılandırmalarınızı yönetin.',
    cs: 'Správa vašich konfigurací API.',
    hu: 'API konfigurációk kezelése.',
    bg: 'Управление на вашите API конфигурации.'
  },
