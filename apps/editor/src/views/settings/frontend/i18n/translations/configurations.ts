export const configurations = {
  'configurations.subtitle': {
    en: 'Directly call APIs from within the editor.',
    pl: 'Bezpośrednio wywołuj API z poziomu edytora.',
    'zh-cn': '直接在编辑器中调用 API。',
    ja: 'エディタから直接APIを呼び出します。',
    'zh-tw': '直接在編輯器中呼叫 API。',
    de: 'Rufen Sie APIs direkt aus dem Editor auf.',
    es: 'Llama a las API directamente desde el editor.',
    fr: "Appelez directement les API depuis l'éditeur.",
    'pt-br': 'Chame APIs diretamente do editor.',
    ru: 'Вызывайте API прямо из редактора.',
    ko: '에디터 내에서 직접 API를 호출하세요.',
    it: "Chiama direttamente le API dall'interno dell'editor.",
    tr: "Editör içinden API'leri doğrudan çağırın.",
    cs: 'Volejte API přímo z editoru.',
    hu: 'API-k közvetlen hívása a szerkesztőből.',
    bg: 'Извиквайте API директно от редактора.'
  },
