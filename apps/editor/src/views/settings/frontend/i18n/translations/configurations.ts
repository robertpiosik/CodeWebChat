export const configurations = {
  'configurations.subtitle': {
    en: 'Manage model providers and their configurations',
    pl: 'Zarządzaj dostawcami modeli i ich konfiguracjami',
    'zh-cn': '管理模型提供商及其配置',
    ja: 'モデルプロバイダーとその設定を管理',
    'zh-tw': '管理模型提供商及其設定',
    de: 'Modellanbieter und deren Konfigurationen verwalten',
    es: 'Administrar proveedores de modelos y sus configuraciones',
    fr: 'Gérer les fournisseurs de modèles et leurs configurations',
    'pt-br': 'Gerenciar provedores de modelos e suas configurações',
    ru: 'Управление поставщиками моделей и их конфигурациями',
    ko: '모델 제공자 및 해당 구성 관리',
    it: 'Gestisci i fornitori di modelli e le loro configurazioni',
    tr: 'Model sağlayıcılarını ve yapılandırmalarını yönetin',
    cs: 'Spravovat poskytovatele modelů a jejich konfigurace',
    hu: 'Modellszolgáltatók és konfigurációik kezelése',
    bg: 'Управление на доставчици на модели и техните конфигурации'
  },
