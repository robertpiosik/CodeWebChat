export const api_calls = {
  ...
  'api-calls.model-providers.extended-cache.anthropic.title': {
  ...
  'api-calls.model-providers.extended-cache.anthropic.description': {
  ...
  'api-calls.model-providers.extended-cache.anthropic.learn-more': {
    en: 'Learn more',
  ...
  'api-calls.model-providers.form.name.label': {
    en: 'Name',
    pl: 'Nazwa',
    'zh-cn': '名称',
    ja: '名前',
  ...
  'api-calls.model-providers.form.name.placeholder': {
    en: 'e.g. OpenAI',
    pl: 'np. OpenAI',
    'zh-cn': '例如 OpenAI',
    ja: '例：OpenAI',
  ...
  'api-calls.model-providers.form.base-url.label': {
    en: 'Base URL',
    pl: 'Bazowy adres URL',
    'zh-cn': '基础 URL',
    ja: 'ベース URL',
  ...
  'api-calls.model-providers.form.base-url.placeholder': {
  ...
  'api-calls.model-providers.form.api-key.label': {
    en: 'API Key',
    pl: 'Klucz API',
    'zh-cn': 'API 密钥',
    ja: 'API キー',
  ...
  'api-calls.model-providers.form.api-key.action.clear': {
    en: 'Clear',
    pl: 'Wyczyść',
    'zh-cn': '清除',
    ja: 'クリア',
  ...
  'api-calls.model-providers.form.api-key.placeholder.cleared': {
    en: 'API Key cleared',
  ...
  'api-calls.model-providers.form.api-key.placeholder.default': {
    en: 'Enter API Key',
