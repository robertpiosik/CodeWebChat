export const actions = {
  ...
  'action.duplicate-preset': {
    ...
    ja: 'プリセットを複製',
    'zh-tw': '複製預設',
    de: 'Voreinstellung duplizieren',
    es: 'Duplicar ajuste preestablecido',
    fr: 'Dupliquer le préréglage',
    'pt-br': 'Duplicar predefinição',
    ru: 'Дублировать пресет',
    ko: '사전 설정 복제',
    it: 'Duplica preimpostazione',
    tr: 'Ön ayarı çoğalt',
    cs: 'Duplikovat předvolbu',
    hu: 'Előbeállítás duplikálása',
    bg: 'Дублиране на шаблона'
  },
