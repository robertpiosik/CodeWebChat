...
const LAST_USED_AGENTIC_CLI_AGENT_STATE_KEY =
  'last_used_agentic_cli_agent_state_key'
const LAST_SELECTED_WORKSPACE_IN_AGENTIC_CLI_STATE_KEY =
...
export const handle_invoke_agentic_cli = async (
  ...
  const result = await invoke_agentic_cli({
    ...
    last_used_agent_state_key: LAST_USED_AGENTIC_CLI_AGENT_STATE_KEY,
