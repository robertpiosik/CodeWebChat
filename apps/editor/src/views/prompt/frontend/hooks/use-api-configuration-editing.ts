...
export const use_api_configuration_editing = (vscode: any) => {
  ...
  const [
    api_configuration_api_prompt_type,
    set_api_configuration_api_prompt_type
  ] = useState<ApiPromptType | undefined>()
  ...
  const edit_api_configuration_save_handler = () => {
    post_message(vscode, {
      ...
      api_prompt_type: api_configuration_api_prompt_type
    })
  }
  ...
  useEffect(() => {
    const handle_message = (event: MessageEvent<BackendMessage>) => {
      ...
      if (message.command == 'API_CONFIGURATION_UPDATED') {
        ...
        set_api_configuration_api_prompt_type(undefined)
        ...
        set_api_configuration_api_prompt_type(message.api_prompt_type)
      }
    }
